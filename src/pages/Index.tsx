        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {categories.map((cat, i) => (
              <motion.div
                key={cat.label}
                className={`flex flex-col items-center rounded-2xl p-6 text-center transition-all hover:shadow-card-hover hover:-translate-y-1 cursor-pointer ${
                  cat.active ? "bg-primary text-primary-foreground shadow-glow-primary" : "bg-card shadow-card"
                }`}
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true }}
